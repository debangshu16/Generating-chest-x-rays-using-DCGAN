...
class DCGAN():
    ...
    def train(self, epochs, batch_size=128, save_interval=50,last_model_point=0):
        ...
        self.combined.save('generated_models/Combined_model_{}'.format(epoch+last_model_point+1))
...
if __name__ == '__main__':
    ...
    if os.path.exists('generated_models/Generator_model_{}'.format(last_model_point)):
        ...
        #dcgan.combined = load_model('generated_models/Combined_model_{}'.format(last_model_point))

    dcgan.train(epochs=100, batch_size=16, save_interval=100,last_model_point=last_model_point)
